// 导入组件和类型
import _Icon from "./icon.vue"; // 导入 Button 组件定义
...
// 包装组件并导出
export const Icon = withInstall(_Icon); // 使用 withInstall 包装 Button 组件，得到一个具有 install 方法的 Button 组件
export default Icon; // 将 Button 组件作为默认导出